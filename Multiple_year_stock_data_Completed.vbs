...
For Each ws In Worksheets
    ...
    'If Tickersymbol change or not equal to the previous one excute to record
        ...
        ' Get the value first day open form the column "C" and last day close of the year on "F"

            year_open = ws.Cells(previous_i, 3).Value
            year_close = ws.Cells(i, 6).Value

        ' A for loop to sum the total stock volume using vol which is found in "G"
